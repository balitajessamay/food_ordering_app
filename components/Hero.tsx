...
const Hero = () => {
  return (
    <section className="mt-[10vh] flex flex-col justify-center h-[80vh] w-auto">
      <div className="flex justify-between px-24">
        <div className="flex flex-col mt-16">
        <h1 className={`text-6xl text-(--accent-color) ${jaroFont.className}`}>Experience Sandwich Bliss</h1>
        <p className="mt-4 text-4xl">Where Every Bite Feels Like a<br /> Relaxing Escape</p>
        <button className={`h-[4rem] w-[15rem] mt-12 py-2 px-4 text-black text-2xl bg-(--accent-color) ${jaroFont.className} shadow-[-12px_16px_0px_0px_#000000] rounded`}>
          Order Now!
        </button>
      </div>
